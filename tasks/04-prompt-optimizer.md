...
- create a module for prompt optimization
- a function that given a prompt, returns the optimized prompt using litellm, for example using a prompt template such as "As your are a 10x Prompt engineer, optimize this prompt : {PROMPT}"
