...
- Write a minimal main function to run the project
- Decribe the best framework for command line interface
- Include rich component for command line interface
